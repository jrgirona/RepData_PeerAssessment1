...
zipdir <- 'DataOrigin'
zipfile <- 'dataset.zip'
files <- download.unzip(zipurl, zipdir, zipfile)
...
barplot(report01$x, width = 1, space = NULL,names.arg = report01$Group.1,main="Number of steps per day", xlab="Date", ylab="Nbr. of steps", col="black")

barplot(report02$x, width = 1, space = NULL,names.arg = report02$Group.1,main="Average of steps per day", xlab="Date", ylab="Average", col="black")

barplot(report03$x, width = 1, space = NULL,names.arg = report03$Group.1,main="Median of steps per day", xlab="Date", ylab="Median", col="black")
...
plot(report04$Group.1 , report04$x, type = "l", main="Average of steps per interval", xlab="Interval from 0 to 2355", ylab="Average per interval")
...
barplot(report06$x, width = 1, space = NULL,names.arg = report06$Group.1,main="Number of steps per day, fulfilling table", xlab="Date", ylab="Nbr. of steps", col="black")

barplot(report07$x, width = 1, space = NULL,names.arg = report07$Group.1,main="Average of steps per day, fulfilling table", xlab="Date", ylab="Average", col="black")

barplot(report08$x, width = 1, space = NULL,names.arg = report08$Group.1,main="Median of steps per day, fulfilling table", xlab="Date", ylab="Median", col="black")
...
colnames(report09) <- c("Interval","Avg. steps","weekend/weekday")
